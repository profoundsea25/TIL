...
## 11. 대규모 언어 모델 미세 조정
### 11.1 미세 조정이란?
- 미세 조정은 사전 훈련된 모델을 새로운 과업에 사용할 수 있게 해주는 기술
  - 일반적으로 모델의 성능을 개선하기 위한 마지막 단계로 수행됨.
- 전이 학습: 한 과업에서 학습한 지식을 활용해 다른 과업의 성능을 향상시키는 머신러닝 기법
- 모델에 맞는 토큰화 알고리즘을 적용해야 한다.

## PART 03. LLM의 윤리와 미래
## 12. 책임 있는 AI
### 12.1 책임 있는 AI란 무엇이며 왜 필요한가?
- 책임있는 AI란 공정성, 포용성, 신뢰성, 안전성, 투명성, 개인 정보 보호 및 보안, 책임감을 준수하는 모델이다.
  - 편애, 차별을 조장해서는 안 된다.

### 12.2 책임 있는 AI 아키텍처
- 책임 있는 AI를 만들기 위해 모델 수준, 메타프롬프트 수준, 사용자 인터페이스 수준에서 개입할 수 있다.
- 모델 수준
  - 훈련 데이터셋의 영향을 받는다.
  - 미세 조정, 사람 피드백(RLHF) 등의 방법이 있음.
- 메타프롬프트 수준
  - 모델이 생성할 유해한 결과를 완화할 수 있다.
  - 악의적인 프롬프트 주입(인젝션)을 방어해야 한다.
